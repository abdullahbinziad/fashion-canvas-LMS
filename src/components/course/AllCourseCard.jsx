...
const AllCourseCard=({index,content})=> {
...
const{user} = UseAuth();
  ...
  const handleAddToCart = (content) => {
    ...
    return (
     <Link to={`/enroll/course/${_id}`}> <Card className="dark:bg-fcDark dark:text-white relative h-full overflow-hidden">
